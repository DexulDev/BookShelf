 ...
 * @version 20/05/26
 */
public class CredencialEstudiante extends Credencial 
{
    public CredencialEstudiante(String nombre, String apellido, String numeroTelefono, String correoElectronico, String direccion, String fechaEmision){
